...
export const settingsEnUS = {
  settings: {
    ...
    // TTS Voice descriptions (Kokoro)
    voiceAfHeart: 'Recommended - Warm, Natural',
    voiceAmMichael: 'Recommended - Clear, Conversational',
    voiceBfEmma: 'Recommended - Polished British',
    voiceBmGeorge: 'Recommended - Deep British',
    voiceAfBella: 'Soft, Pleasant',
    voiceAfNova: 'Bright, Energetic',
    voiceAfSarah: 'Calm, Natural',
    voiceAfSky: 'Light, Expressive',
    voiceAmAdam: 'Neutral, Steady',
    voiceAmEric: 'Clear, Confident',
    voiceAmLiam: 'Smooth, Conversational',
    voiceBfAlice: 'Elegant British',
    voiceBfLily: 'Soft British',
    voiceBfIsabella: 'Classic British',
    voiceBmDaniel: 'Neutral British Male',
    voiceBmLewis: 'Young, Energetic British',
    // ASR Language names (native forms - autoglossonyms)
